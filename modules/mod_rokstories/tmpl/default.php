	...
	<div class="desc-container">
		...
		<div class="description">
		    <?php if ($params->get("show_article",1)==1): ?>
				...
				<!--<div class="clr"></div><div class="readon-wrap1"><div class="readon1-l"></div><a href="<?php echo $item->link; ?>" class="readon-main"><span class="readon1-m"><span class="readon1-r"><?php echo $params->get("readon_text","Read the Full Story"); ?></span></span></a></div>-->
                <div class="clr"></div>
			<?php endif; ?>
		</div>
        <?php endforeach; ?>
